...
SUPPORTED_VERSIONS_CLASSIFIERS = [
    "Programming Language :: Python :: {version}".format(version=version)
...
setup(
    ...
    entry_points={"console_scripts": ["secedgar=secedgar.cli:cli"]},
    cmdclass={
        "install": install,
    },
    ...
    extras_require={
        ...
        ':python_version == "3.6"': ["typing_extensions<4.2.0"],
    },
